 ...
 * @author 高贵血迹
 */global $_W, $_GPC;
   $operation = in_array ( $_GPC ['op'], array ('default','reciveConfirm', 'delmallorder', 'mallorder','sigeup','deleteclass','creatorder','xuefeiidcard','xufeiob','buyvod','xgks','chongzhi') ) ? $_GPC ['op'] : 'default';
