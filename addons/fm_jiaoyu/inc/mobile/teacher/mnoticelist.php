 ...
 */
		...
		if($thistime){
		    ...
		    $leave1 = pdo_fetchall("SELECT id,title,tname,createtime,type,tid,content,usertype FROM " . tablename($this->table_notice) . " where weid = '{$weid}' And schoolid = '{$schoolid}' And type = 2   $condition  ORDER BY createtime DESC LIMIT 0,5 ");			
		    ...
		    $leave = pdo_fetchall("SELECT id,bj_id,title,tname,createtime,type,tid,content,usertype FROM " . tablename($this->table_notice) . " where weid = '{$weid}' And schoolid = '{$schoolid}' And type = 2    ORDER BY createtime DESC LIMIT 0,5 ");
