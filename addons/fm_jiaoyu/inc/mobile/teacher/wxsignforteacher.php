 ...
 */
        ...
        if(!empty($it)){
			$school = pdo_fetch("SELECT title,style3,headcolor,lat,lng,wxsignrange FROM " . tablename($this->table_index) . " where weid = :weid AND id=:id ", array(':weid' => $weid, ':id' => $schoolid));
