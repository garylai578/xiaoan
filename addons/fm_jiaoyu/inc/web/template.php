...
/*     foreach($iconsFF as $keyF => $valueF){
	...
	$icon10 = array('weid' => $weid,'schoolid' => $schoolid,'name' =>'评价的公开课','icon' => MODULE_URL.'public/mobile/img/circle_icon711.png','url' => $this -> createMobileUrl('gkkpjjl', array('schoolid' => $schoolid)),'place' => 13,'do'=>'gkkpjjl','ssort' => 10,'status' => 1,);
