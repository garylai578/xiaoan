				...
				<div id="credit-status1" <?php  if($item['macname'] == 2 || $item['macname'] == 5 || $item['macname'] == 6) { ?>style="display:block"<?php  } else { ?>style="display:none"<?php  } ?>>
					...
					<div id="credit-status66" <?php  if($item['macname'] == 6) { ?>style="display:block"<?php  } else { ?>style="display:none"<?php  } ?>>
						<div class="form-group">
							...
							<div class="col-sm-9 col-xs-12">
								<label class="radio-inline">
									<input type="radio" value="1" class="printer-type credit7" name="is_bobao" <?php  if($item['is_bobao'] == '1' || empty($item['is_bobao'])) { ?>checked<?php  } ?> <?php  if($item && $item['is_bobao'] != 1) { ?>disabled<?php  } ?> id="credit7"> 考勤机
								</label>
						...
						<tr>
							...
							<td class="qx_2403">
                                ...
                                <?php  } else if($item['macname'] == '6') { ?>
                                	<a class="btn btn-default" href="javascript::;"  data-toggle="tooltip" data-placement="top" title="执行任务" onclick="show_order6(<?php  echo $item['id'];?>);">执行任务</a>							
								<?php  } else { ?>
