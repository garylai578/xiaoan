...
<div class="panel panel-info">
	...
	<div class="panel-body">
            <div class="form-group">
                <a class="btn btn-primary btn-sm qx_1402" href="<?php  echo $this->createWebUrl('article', array('op' => 'post', 'schoolid' => $schoolid))?>">添加公告</a>
			...
			<tbody>
				...
				<tr>
					...
					<td style="text-align:right; position:relative;">
						<a  class="bj" href="<?php  echo $this->createWebUrl('article', array('op' => 'post', 'id' => $item['id'], 'schoolid' => $schoolid))?>" title="编辑">编辑</a>&nbsp;-&nbsp;
						<a class="qx_1403" onclick="return confirm('此操作不可恢复，确认吗？'); return false;" href="<?php  echo $this->createWebUrl('article', array('op' => 'delete', 'id' => $item['id'], 'schoolid' => $schoolid))?>" title="删除">删除</a>
					</td>
				</tr>
				<?php  } } ?>
			</tbody>
...
<script type="text/javascript">
	$(function(){
		<?php  if(!(IsHasQx($tid_global,1001402,1,$schoolid))) { ?>
			$(".qx_1402").hide();
			$(".bj").attr("title","查看");
			$(".bj").html("查看");
			$("#Layer2").show();
		...
		<?php  } ?>
		<?php  if(!(IsHasQx($tid_global,1001403,1,$schoolid))) { ?>
			$(".qx_1403").hide();
		<?php  } ?>
