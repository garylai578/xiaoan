        ...
        <div class="panel-body">
            <form action="./index.php" method="get" class="form-horizontal" role="form">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-2 col-lg-2">                      
                        <a class="btn btn-primary qx_tj" href="<?php  echo $this->createWebUrl('cook', array('op' => 'post', 'schoolid' => $schoolid))?>"><i class="fa fa-plus"></i> 添加食谱</a>
                    </div>
                </div>    
            </form>
        </div>
...
<div class="main">
	<?php  if(!IsHasQx($tid_global,1000402,1,$schoolid)) { ?>
...
$(document).ready(function() {
	...
	<?php  if(!(IsHasQx($tid_global,1000402,1,$schoolid))) { ?>
		...
		$(".qx_tj").hide();
		$(".qx_edit").attr("title","查看");
		e_d = e_d - 1 ;
	<?php  } ?>
	<?php  if(!(IsHasQx($tid_global,1000403,1,$schoolid))) { ?>
		$(".qx_delete").hide();
		e_d = e_d - 1 ;
	<?php  } ?>
	if(e_d == 0){
