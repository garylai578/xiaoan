...
<link rel="stylesheet" type="text/css" href="<?php echo OSSURL;?>public/mobile/css/new_yab.css?v=1?v=1111" />
...
.slide_left_menu_ul li.act {background: url(<?php echo OSSURL;?>public/mobile/img/be_choose_icon.png) right center no-repeat;background-size: 16px;background-origin: content-box;-moz-background-origin: content-box;-webkit-background-origin: content-box;}
</style>
</head>
<body>
...
<section>
    <div class="conentBox">
		...
		<div class="top_bottom" id="StuID" stuuid=""></div>
    </div>
</section>
...
<!--左边弹窗-->
<div class="slide_left_menu_bg show_menu_bg">
    <div class="slide_left_menu">
        <div class="slide_left_menu_til">
            学生列表
        </div>
        <ul class="slide_left_menu_ul">
		<?php  if(is_array($students)) { foreach($students as $row) { ?>
			<li <?php  if($sid == $row['id']) { ?>class="act"<?php  } ?> stu_uid="<?php  echo $row['id'];?>">
				<div class="user_img">
...
//获取状态数据
function GetAttendData(time, stu_uid) {
	$.ajax({
		...
		success: function (data) {
			...
			$(".top_bottom").html(dt.StuName);
			$("#StuID").attr("StuUid", dt.TeacherName);			
...
$(".slide_left_menu_ul").on("click", "li", function(e) {
...
switch (type) {
	...
	case "我要签到":
		...
		break;
	case "我要请假":
		window.location.href = "/1046/Leave/Leave";
		break;
	case "请假记录":
		window.location.href = "/1046/AttendCalendar/LeaveList";
		break;
	default:
		break;
}
