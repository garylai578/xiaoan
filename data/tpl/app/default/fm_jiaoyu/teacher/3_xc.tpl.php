...
.image-check {background: url(<?php echo OSSURL;?>public/mobile/img/check_icon_on.png);top: 5%;right: 6.7%;z-index: 3;position: absolute;width: 25%;height: 25%;background-size: 100% 100%;display: none;}
.image-all-checked {
background: url(<?php echo OSSURL;?>public/mobile/img/icon-checked.png);
...
setTimeout(function() {
	...
	var sxc = '<?php  echo  $this->createMobileUrl('xc', array('schoolid' => $schoolid, 'getalist' => 1, 'type' => $_GPC['type'], 'sid' => $_GPC['sid'], 'bj_id' => $_GPC['bj_id'] ))?>';
