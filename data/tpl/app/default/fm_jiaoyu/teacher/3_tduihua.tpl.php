	...
	<?php  if($row['userid'] == $it['id']) { ?>
		<?php  if(!empty($row['audio'])) { ?>
				...
				<div class="avatar" data-author-id="lj">
					<img src="<?php  if($teachers['thumb']) { ?><?php  echo tomedia($teachers['thumb'])?><?php  } else { ?><?php  echo tomedia($school['tpic'])?><?php  } ?>" >
				</div>
				<div class="content">
...
<input id="touserid" value="<?php  if($thisleave['userid'] == $it['id']) { ?><?php  echo $thisleave['touserid'];?><?php  } else { ?><?php  echo $thisleave['userid'];?><?php  } ?>" type="hidden">
...
function ajax_upload(url, data, self) {
	$.ajax({
		...
		success: function (datas) {
			...
			self.hideLoadingMsg();
			if (datas.result) {
				var imgSrc = "<?php  if($teachers['thumb']) { ?><?php  echo tomedia($teachers['thumb'])?><?php  } else { ?><?php  echo tomedia($school['tpic'])?><?php  } ?>";
				var MyDate = new Date();
