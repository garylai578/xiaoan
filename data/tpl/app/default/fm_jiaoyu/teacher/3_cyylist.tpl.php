...
<div id="titlebar" class="header mainColor">
	...
	<div class="m"><a><span style="font-size: 18px">课程预约试听</span></a></div>
...
// 底部加载更多
	new Scroll_load({
		...
		"ajax_url": "<?php  echo $this->createMobileUrl('cyylist', array('schoolid' => $schoolid), true)?>",
	   ...
	   strConvertHtml();
		...
		$('body').on('click',  '.main', function(e) {
			if (!$(e.target).parent().is('.notifyImgItem')) {
				...
				window.location.href = "<?php  echo $this->createMobileUrl('cyydetail', array('schoolid' => $schoolid))?>"+ '&id=' + notifyUid;
			} 
		});
