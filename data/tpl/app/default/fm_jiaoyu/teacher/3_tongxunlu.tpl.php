...
.icon_btn_call {width: 50px;height: 55px;background: url(<?php echo OSSURL;?>public/mobile/img/partent_ico_phone.png) no-repeat center;background-size: 20px;}
...
<div class="ADVtips" style="margin-top: 60px">
...
<div class="contentBg">
	...
	<div class="teacher_box" count="11">
		...
		<div count="<?php  echo $masterCount2;?>" name="老师">
			<div class="common_til2">
				<a href="###" class="joeBoxA" onclick="openShutManager(this,'老师','老师（<?php  echo $masterCount2;?>人）','老师（<?php  echo $masterCount2;?>人）')">老师（<?php  echo $masterCount2;?>人）</a>
			</div>
			<div class="common_box1" style="">
				<div class="main_box2" style="padding:0 0; display:none;"  id="老师">
					<ul class="common_list_imgtext2">
		...
		if(isConfirm){
		    ...
		    $.post("<?php  echo $this->createMobileUrl('dongtaiajax',array('op'=>'savely'))?>",submitData,function(data){
		        if(data.result){
		            PB.prompt(data.msg);
		   			closeReplyBox();
					window.location.href = "<?php  echo $this->createMobileUrl('tlylist', array('schoolid' => $schoolid), true)?>"
		        }else{
		            PB.prompt(data.msg);
		        }
		    },'json'); 
