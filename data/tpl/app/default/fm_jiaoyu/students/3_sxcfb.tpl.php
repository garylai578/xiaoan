		...
		<div class="xcShareBox">
			<div class="r">
				...
				<div class="selectList">
					<div class="double" id="bjList">
						...
						<ul>
							<?php  if(!empty($bj_id)) { ?><li onclick="isCheck(this);"><span name="checkName" class="le"><?php  echo $bjidname;?></span><span class="ri"><img alt="check" src="<?php echo OSSURL;?>public/mobile/img/check.png" /></span><input type=hidden name="check" value="<?php  echo $bj_id;?>" /></li><?php  } ?>						
						</ul>
			...
			<li class="no_padding">
				...
				<span class="remind">
					...
					<label>注:</label>
					<label>您首次上传的第一张照片会成为相册封面,请慎重</label>
				</span>
			</li>
    		<div class="cl"></div>
		</div>
...
function sendPhoto(){
	...
	if (confirm("确定发布?")) {
	    ...
	    $.post("<?php  echo $this->createMobileUrl('dongtaiajax',array('op'=>'sxcfb'))?>",submitData,function(data){
