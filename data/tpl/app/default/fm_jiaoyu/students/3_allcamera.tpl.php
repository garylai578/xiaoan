...
<div class="header mainColor">
	...
	<div class="m">
		<a id="Changesf">
			<span style="font-size: 18px"><?php  echo $student['s_name'];?></span>
			<?php  if($bdsun > 1) { ?><i></i><?php  } ?>
		</a>
	</div>
</div>  
<div>
<?php  if($mybj['video'] || $list) { ?>
	<ul class="baby_video_list" style="margin-top:60px;">
	<?php  if($mybj['video']) { ?>
		<li>
...
setTimeout(function() {
	if(window.__wxjs_environment === 'miniprogram'){
		$("#titlebar").hide();
		$("#titlebar_bg").hide();
		document.title="<?php  echo $student['s_name'];?>";
	}
}, 100);
