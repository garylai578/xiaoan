...
<body>
	<div class="header mainColor" id="titlebar">
		<div class="l">
			<a class="backOff" style="background:url(<?php echo OSSURL;?>public/mobile/img/ic_arrow_left_48px_white.svg) no-repeat;background-size: 55% 55%;background-position: 50%;" href="javascript:history.back(-1);"></a>
		</div>
		<div class="m">
	...
	<div class="list list_mt0 list" style="padding-bottom:50px">
		...
		<div class="listContent"> 
			...
			<?php  if(is_array($list)) { foreach($list as $item) { ?>
				<ul>
					<a href="<?php  echo $this->createMobileUrl('sduihua',array('schoolid' => $schoolid,'id' => $item['id']), true)?>">
						<li style="border-radius: 15px;">
							...
							<?php  } ?>
								...
								：<?php  echo $r['conet'];?><?php  if($r['touserid'] == $it['id']) { ?><?php  if($r['isread']==1) { ?><span class="wd" style="color:#fff;">未读</span><?php  } ?><?php  } ?>
							</div>
