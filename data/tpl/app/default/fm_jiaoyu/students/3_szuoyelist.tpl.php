...
<title><?php  echo $language['szuoyelist_title'];?></title>
</head>
<body>
<div class="All">       
	<span id="qbyd">全部已读</span>
	<div class="blank"></div>
	<div class="blank"></div>
...
setTimeout(function() {
	if(window.__wxjs_environment === 'miniprogram'){
		document.title="<?php  echo $language['szuoyelist_title'];?>";
	}
}, 100);
$("#qbyd").click(function () {
	jConfirm("<?php  echo $language['szuoyelist_jstip'];?>", "删除确定对话框", function (isConfirm) {
		if(isConfirm){
			var submitData = {
